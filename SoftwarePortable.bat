...
echo "2: Copy the chosen Software to an external Device with deleting all the original files" 
echo "3:30MB" 
choice /c 123 /m "Please choose an option from the upper options:"
pause
